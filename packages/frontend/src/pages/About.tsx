      ...
      </p>
      {
        loading ? (<div className="flex items-center justify-center h-64">
          ...
          <div className='col-span-12 xl:col-span-9 flex flex-col'>
            ...
            uppercase flex items-center gap-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-blue-200 h-max'>
          ...
          <div className="col-span-12 xl:col-span-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 md:p-8">
            <p className="text-xl font-medium text-blue-600 mb-4">{t(resourcesMap.about.experience)}</p>
            <ul className="mt-2 space-y-3">
              <li className="text-lg text-gray-800 dark:text-gray-300 border-slate-700 dark:border-slate-200 border-l-2 py-1 pl-4 hover:pl-6 transition-all duration-300 cursor-pointer hover:border-blue-600 dark:hover:border-blue-600">
              ...
              <li className="text-lg text-gray-800 dark:text-gray-300 border-slate-700 dark:border-slate-200 border-l-2 py-1 pl-4 hover:pl-6 transition-all duration-300 cursor-pointer hover:border-blue-600 dark:hover:border-blue-600">
                ...
                <p className="text-gray-800 dark:text-gray-100 font-medium text-lg">Software Engineer</p>
          ...
          {/* Education */}
          <div className="col-span-12 xl:col-span-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 md:p-8">
            <p className="text-xl font-medium text-blue-600 mb-4">{t(resourcesMap.about.education)}</p>
          ...
          <div className="col-span-12 bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 md:p-8">
            <p className="text-xl font-medium text-blue-600 mb-2">{t(resourcesMap.about.technologies)}</p>
            <p className="text-lg text-gray-800 dark:text-gray-300 mb-4">{t(resourcesMap.about.technologiesDescription)}</p>
            <div className="flex flex-wrap gap-4">
              {technologies.map((technology) => (
                <div key={technology.id} className="flex items-center gap-2 border rounded-md border-slate-300 dark:border-slate-600 px-4 py-1 cursor-pointer hover:shadow-lg hover:translate-y-[-2px] transition-all duration-300 hover:border-blue-600 dark:hover:border-blue-600">
